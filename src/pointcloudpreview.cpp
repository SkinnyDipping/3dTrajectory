...
void PointCloudPreview::paintGL()
{
    ...
    view.lookAt(QVector3D(-translationX/10,-translationY/10,0+wheelAngle/15.0f+initialZoom),  //eye
                QVector3D(-translationX/10,-translationY/10,1+wheelAngle/15.0f+initialZoom),  //center
                QVector3D(0,1,0));                              //up
